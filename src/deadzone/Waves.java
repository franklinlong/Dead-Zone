...
public class Waves implements Runnable {
    ...
    public void createStandardZommbie(float x, float y, float mulHealth, float prob) {
        ...
        switch(n){
            case 0:
                this.handler.addSprite((new StandardZombie(x, y, 1, (int) (100 * mulHealth), handler.getPlayer(), this.handler, prob, 60, 60, 5, new Animation(Assets.zombie, 20), 
                            new Animation(Assets.zombieAttack, 35), new Sound(Assets.zombieBite), new Sound(Assets.zombieHit))));
                break;
            case 1:
                this.handler.addSprite((new SpittleZombie(x, y, 1, (int) (100 * mulHealth), handler.getPlayer(), this.handler, prob, 60, 60, 5, new Animation(Assets.zombie, 20), 
                            new Animation(Assets.zombieAttack, 35), new Sound(Assets.zombieBite), new Sound(Assets.zombieHit))));
                break;
        }
    }
