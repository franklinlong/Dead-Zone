...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        int h = new ImageIcon(getClass().getResource("mano_zombie3.gif")).getIconHeight()*1/3;
        ImageIcon gif = ridimensionaImageIcon(getClass().getResource("mano_zombie3.gif"),w,h);
        
        
        w = new ImageIcon(getClass().getResource("LogoBiancoENero.png")).getIconWidth()*1/3;
        h = new ImageIcon(getClass().getResource("LogoBiancoENero.png")).getIconHeight()*1/3;
        ImageIcon immagineLogo = ridimensionaImageIcon(getClass().getResource("LogoBiancoENero.png"),w,h);
