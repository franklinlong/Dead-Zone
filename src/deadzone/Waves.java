...
//                System.out.println("Splitt da creare: " + this.numSpittleToCreate);
    ...
    public void createBoss(float x, float y, float mulHealth, float prob) {
        this.handler.addSprite(new Boss(x, y, (float) 0.5, 4000, 75, handler.getPlayer(), this.handler, prob, 120, 120, 100, new Animation(Assets.boss, 40), new Animation(Assets.bossAttack, 50), new Animation(Assets.bossdeath, 70), new Sound(Assets.zombieBite), new Sound(Assets.zombieHit)));
    }
